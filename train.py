...
from dataset_my import get_dataloaders
...
parser.add_argument('--data_path', default='D:/datasets/fer2013_plus_combine', type=str)
...
def main():
    ...
    # dataloaders
    train_loader, test_loader = get_dataloaders(args.dataset, args.data_path, args.batch_size, args.num_workers)
    #train_loader = getdataloaders_affectnet8(r'E:\datasets\AffectNet\processed',True)
    #test_loader = getdataloaders_affectnet8(r'E:\datasets\AffectNet\processed',False)
